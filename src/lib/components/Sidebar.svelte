	...
	<div class="px-3 pt-3 pb-1">
		<div class="mb-2 flex items-center gap-1">
			<button
				...
				class="flex flex-1 items-center gap-2 rounded-md px-3 py-1.5 text-sm font-medium transition-colors {!currentUuid && !isProjectsPage && !isSettingsPage
			...
			{#if onToggleSidebar}
				<button
					...
					class="rounded-md p-1.5 text-text-secondary hover:bg-bg-primary hover:text-text-primary"
